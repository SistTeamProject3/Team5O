...
<body>
	...
	<hr>
	<div id="_add_content">
		<button type="button" class="btn btn-info" onclick="modify_content()">자기소개 추가</button>
	</div>

	<textarea class="form-control" id="_basics_content" name="m_content" cols="120" rows="6" readonly="readonly">${login.m_content}</textarea>
	<button type="button" id="_modify_content" class="btn btn-info" onclick="modify_content()">자기소개 수정</button>

	<div id="_modify_btn">
		<button type="button" class="btn btn-info" onclick="modify_content2()">완료</button>
		<button type="button" class="btn btn-info" onclick="content_cancel()">취소</button>
	</div>
