...
<form class="form-horizontal" name="addmember" id="addmember">
  <fieldset>
	...
	<tr>
		...
		<td>
			<input class="form-control" id="_id2" type="text" name="m_id2" size="30" value="">
		</td>
		<td>
	...
	<tr>
		...
		<td style="text-align: left;">
			<button type="button" class="btn btn-info"  onclick="a_number()">인증확인</button>
		</td>
		<td colspan="2">
			메시지 띄울 td
		</td>
	...
	<tr>
		...
		<td>
			<input class="form-control" id="_pwd2" type="password" placeholder="비밀번호 재입력">
		</td>
		<td colspan="2">
			비밀번호 맞는지 아닌지 띄울 창.
		</td>
	...
	<tr>
		<td><button type="button" class="btn btn-info" onclick="">가입완료</button></td>
		<td><button type="button" class="btn btn-info" onclick="">취소</button></td>
	</tr>
