...
<td class="c_name">${clist.m_id } :</td>
<td class="c_content">${clist.n_content }</td>
<td class="c_time">${clist.n_wdate }</td>
</tr>
...
<td colspan="4"><a href="#none" class="add_coment" data-set="${l_num+10}" data-set2="${clist.n_parent }">댓글 더보기</a></td>
</tr>
</c:if>
</c:forEach>
</table>
